...
// upvote an article and remove any existing downvote on that article
...
// upvote a comment and remove any previous downvote on that comment
...
yaml(loadDatabase(err, data) {
if (err) throw err;
console.log(data);
});

function saveDatabase {
writeFile('server.js', function(err) {
